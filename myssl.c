...
SSL_CTX* SSL_create_ctx(void){
  ...
  /* Load the error strings for SSL & CRYPTO APIs */
    ...
    handle_err(SSL_CTX_use_certificate_file(ctx, "client.crt", SSL_FILETYPE_PEM));

		/* Load the private-key corresponding to the client certificate */
    handle_err(SSL_CTX_use_PrivateKey_file(ctx, "client.key", SSL_FILETYPE_PEM));
  ...
  handle_err(SSL_CTX_load_verify_locations(ctx, RSA_CLIENT_CA_CERT, NULL));
